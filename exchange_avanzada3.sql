...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-02-2019 a las 19:24:41
...
INSERT INTO `contacto` (`id`, `nombre`, `email`, `informacion`) VALUES
(1, 'Jose', 'jose@gmail.com', 'Me gustaria que agregaras nuevas ciudades'),
(2, 'Jose Alberto', 'joseA@gmail.com', 'No he podido ponerme en contacto con cierto vendedor'),
(3, 'adfasdfasdf', 'antonio@gmail.com', 'antonio@gmail.com');
...
INSERT INTO `mensajes` (`id`, `remitente`, `contenido`, `leido`) VALUES
(2, 'cosa@gmail.com', 'hola', 0),
(3, 'cosa@gmail.com', 'asdfasdfadfasdfasf', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mensajes_user`
--

CREATE TABLE `mensajes_user` (
  `mensajes_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `mensajes_user`
--

INSERT INTO `mensajes_user` (`mensajes_id`, `user_id`) VALUES
(3, 7);
...
('20190227163814', '2019-02-27 16:40:55'),
('20190227182338', '2019-02-27 18:24:16');
...
(14, 3, 2, 'Me gusta arreglar ordenadores', 2, NULL, 2, '20190227', '0'),
(15, 1, 2, 'Hola', 2, NULL, 2, '20190227', '0');
...
--
-- Indices de la tabla `mensajes_user`
--
ALTER TABLE `mensajes_user`
  ADD PRIMARY KEY (`mensajes_id`,`user_id`),
  ADD KEY `IDX_A11900E94481E9A2` (`mensajes_id`),
  ADD KEY `IDX_A11900E9A76ED395` (`user_id`);
...
--
-- Filtros para la tabla `mensajes_user`
--
ALTER TABLE `mensajes_user`
  ADD CONSTRAINT `FK_A11900E94481E9A2` FOREIGN KEY (`mensajes_id`) REFERENCES `mensajes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_A11900E9A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE;
